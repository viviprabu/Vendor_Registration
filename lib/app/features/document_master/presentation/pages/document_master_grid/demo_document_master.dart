...
final List<DocumentMaster> demoDocumentMasters = [
  DocumentMaster(
    imagePath: _DocumentMasterProfile.$1,
    name: 'Courtney Henry',
  ...
  DocumentMaster(
    imagePath: _DocumentMasterProfile.$2,
    name: 'Courtney Henry',
  ...
  DocumentMaster(
    imagePath: _DocumentMasterProfile.$3,
    name: 'Charlie Brown',
  ...
  DocumentMaster(
    imagePath: _DocumentMasterProfile.$4,
    name: 'Diana Prince',
    designation: 'UI/UX Designer',
    followers: '1500',
    following: '850',
  ...
  DocumentMaster(
    imagePath: _DocumentMasterProfile.$5,
    name: 'Evan Williams',
  ...
  DocumentMaster(
    imagePath: _DocumentMasterProfile.$6,
    name: 'Fiona Green',
  ...
  DocumentMaster(
    imagePath: _DocumentMasterProfile.$7,
    name: 'George Hill',
  ...
  DocumentMaster(
    imagePath: _DocumentMasterProfile.$8,
    name: 'Hannah Davis',
  ...
  DocumentMaster(
    imagePath: _DocumentMasterProfile.$9,
    name: 'Isaac Newton',
  ...
  DocumentMaster(
    imagePath: _DocumentMasterProfile.$10,
    name: 'Jane Austen',
