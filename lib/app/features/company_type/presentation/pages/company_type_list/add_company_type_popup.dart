...
class AddCompanyTypeDialog extends StatefulWidget {
  const AddCompanyTypeDialog({super.key});

  @override
  State<AddCompanyTypeDialog> createState() => _AddCompanyTypeDialogState();
}

class _AddCompanyTypeDialogState extends State<AddCompanyTypeDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<CompanyTypeBloc, CompanyTypeState>(
      listener: (listenerContext, listenerState) {
        ...
        if (listenerState is CompanyTypeCreateState) {
          if (listenerState.companyType.id != null) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text('CompanyType Added Successfully'),
              ),
            );
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text('CompanyType Addition Failed'),
              ),
            );
          }
        }
