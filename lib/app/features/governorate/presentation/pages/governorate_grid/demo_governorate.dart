...
final List<Governorate> demoGovernorates = [
  Governorate(
    imagePath: _GovernorateProfile.$1,
    name: 'Courtney Henry',
  ...
  Governorate(
    imagePath: _GovernorateProfile.$2,
    name: 'Courtney Henry',
  ...
  Governorate(
    imagePath: _GovernorateProfile.$3,
    name: 'Charlie Brown',
  ...
  Governorate(
    imagePath: _GovernorateProfile.$4,
    name: 'Diana Prince',
    designation: 'UI/UX Designer',
    followers: '1500',
    following: '850',
  ...
  Governorate(
    imagePath: _GovernorateProfile.$5,
    name: 'Evan Williams',
  ...
  Governorate(
    imagePath: _GovernorateProfile.$6,
    name: 'Fiona Green',
  ...
  Governorate(
    imagePath: _GovernorateProfile.$7,
    name: 'George Hill',
  ...
  Governorate(
    imagePath: _GovernorateProfile.$8,
    name: 'Hannah Davis',
  ...
  Governorate(
    imagePath: _GovernorateProfile.$9,
    name: 'Isaac Newton',
  ...
  Governorate(
    imagePath: _GovernorateProfile.$10,
    name: 'Jane Austen',
