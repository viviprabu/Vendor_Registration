...
class _EditAreaDialogState extends State<EditAreaDialog> {
 ...
 final FormGroup areaForm = FormGroup({
  ...
  @override
  void initState() {
    final areaDetail = widget.areaData;
    final areaId = areaDetail.id ?? '';
    context.read<AreaBloc>().add(AreaListEvent(areaId));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<AreaBloc, AreaState>(
      listener: (listenerContext, listenerState) {
        ...
        if (listenerState is AreaUpdateState) {
      ...
      child: AlertDialog(
        ...
        content: BlocBuilder<AreaBloc, AreaState>(
          builder: (blocContext, blocState) {
            if (blocState is AreaListState) {
              final AreaDetails = blocState.area;
              areaForm.controls['nameAr']!.value = AreaDetails.nameAr ?? '';
              areaForm.controls['nameEn']!.value = AreaDetails.nameEn ?? '';
              areaForm.controls['governorateId']!.value = AreaDetails.nameEn ?? '';
