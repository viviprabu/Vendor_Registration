...
class _GaugeChartState extends State<GaugeChart> {
  ...
  Widget build(BuildContext context) {
    const double gaugeWidth = 124;
    const double gaugeHeight = 60;
    return Stack(
...
class GaugeChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    const double startAngle = -math.pi / 1;
          ...
          children: [
            ...
            Positioned(
              ...
              child: Container(
                ...
                child : Icon(Icons.emoji_emotions,size: gaugeWidth * 0.2,color: FinanceAppColors.kWarning),
                // ),
              ),
            ),
          ],
